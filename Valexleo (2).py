...
def get_local_ip():
    ...
    try:
        # Google DNS adresine bağlanıp IP'yi alıyoruz, dışarıya bağlanmadan sadece IP alımı
 ...
 \ \_/ / |  | | |    | |__  | (___ | |    | (___
  \   /| |  | | |    |  __|  \___ \| |     \___ \
   ...
   |_|  \____/|______|______|_____/ \_____|_____/
        ...
        print(Fore.YELLOW + "[1] IP Port Taraması")
        print(Fore.YELLOW + "[2] Subdomain Taraması")
        print(Fore.YELLOW + "[3] Whois Sorgulama")
        print(Fore.YELLOW + "[4] IP Geolocation (Konum Bilgisi)")
        print(Fore.RED + "[5] Kendi IP adresimi öğren")
        print(Fore.YELLOW + "[6] Web Sitesi Kaynak Kodunu Kaydet")
        print(Fore.YELLOW + "[7] SSL Sertifikası Bilgisi")
        print(Fore.YELLOW + "[8] Ping Testi")
        print(Fore.YELLOW + "[9] Traceroute")
        print(Fore.YELLOW + "[10] Ağ Açığı Taraması")
        print(Fore.YELLOW + "[11] DNS Zone Transfer (AXFR)")
        print(Fore.YELLOW + "[12] Site Güvenlik Seviyesi Analizi(HTTP/HTTPS)")
        print(Fore.YELLOW + "[13] Bağlı Olduğun Wi-Fi Bilgileri")
        print(Fore.YELLOW + "[14] Ağdaki Aktif Cihazları Tara")
        print(Fore.YELLOW + "[15] HTTP Güvenlik Başlıkları Taraması")
        print(Fore.YELLOW + "[16] Dizin/Endpoint Keşfi (DirScan)")
        print(Fore.YELLOW + "[17] Gelişmiş Endpoint/Dizin Keşfi")
        print(Fore.YELLOW + "[18] Yayınlanan Açık Dosyaları Tara (.env, .git vs)")
        print(Fore.YELLOW + "[19] Robots.txt Taraması")
        print(Fore.YELLOW + "[20] Port Tabanlı Servis Tanıma(tahminleme)")
        print(Fore.YELLOW + "[21] IP Adresinden Detaylı Lokasyon (İl, İlçe, Koordinat)")
        print(Fore.YELLOW + "[22] Tool Bilgisi")
        ...
        choice = input(Fore.CYAN + "Seçimini yap (0-10): " + Style.RESET_ALL)
        ...
        if choice == "1":
            ...
            print(Fore.GREEN + "GitHub   : https://github.com/amrhn")
